 ...
 * @description Customised Scene for creating a new receiver.
 */

public class NewReceiverScene {
    public static Scene createReceiverScene(Stage stage, Package packageData, Customer selectedCustomer){

        CompanyTableCreation company = CompanyTableCreation.getInstance();

        // HBox for heading
        CustomLabel heading = new CustomLabel("Add New Receiver");
        ...
        CustomButton addButton = new CustomButton("Create Receiver");
        ...
        addButton.setOnAction(event -> {
            if (firstNameTF.getText().equals("")||lastNameTF.getText().equals("")||contactTF.getText().equals("")||emailTF.getText().equals("")||
                ...
                if (companyComboBox.getSelectionModel().getSelectedItem()==null){
                    ...
                    Customer receiverCustomer= customerTableCreation.addCustomerWOCompany(newCustomer);
                    resultLabel.setText("Customer Added");
                    vBox.getChildren().add(resultLabel);

                    //selecting the customer directly from here
                    Scene finalScene = FinalPackageScene.createConfirmationScene(stage,packageData,selectedCustomer,receiverCustomer);
                    ...
                    Customer receiverCustomer = customerTableCreation.addCustomerWCompany(newCustomer);
        ...
        addCompanyBtn.setOnAction(event -> {
            Scene companyFormScene = NewReceiverCompany.createCompanyScene(stage,packageData,selectedCustomer);
        ...
        backButton.setOnAction(event -> {
            Scene receiverSelectionScene = ReceiverSelectionScene.createReceiverTableScene(stage,packageData,selectedCustomer);
            stage.setScene(receiverSelectionScene);
        });
